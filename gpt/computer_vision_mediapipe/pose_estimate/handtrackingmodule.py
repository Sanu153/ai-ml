...
class handDetector():
    def __init__(self,mode=False,modelComplexity=1,maxHands=2,detectionCon=0.5,trackCon=0.5):#constructor
        self.mode=mode 
        ...
        self.hands=self.mpHands.Hands(self.mode,self.modelComplexity,self.maxHands,self.detectionCon,self.trackCon) #object for Hands for a particular instance
